...
function showGrid(parsedData, vendors) {
    ...
    const gridOptions = {
        ...
        columnDefs: [
            ...
            {field: 'savedValue', headerName: 'חיסכון בתקופת זמן', width: 200,  valueFormatter: p => Math.round(p.value)},
        ]
    };
...
window.onload = () => {
    ...
    showGrid(parsedData, window.vendors);
}
